...
export function SendModal({ isOpen, onClose }: SendModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 bg-black/50 flex items-end justify-center md:items-center z-100"
      onClick={onClose}
    >
      <div
        className="bg-gray-100 dark:bg-gray-800 w-full md:w-96 md:rounded-lg mt-auto sm:mt-24 relative"
