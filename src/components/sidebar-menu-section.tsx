          ...
          if (item.clickable === true) {
            return (
              <button
                ...
                className={cn(
                  "flex items-center w-full text-sm font-medium text-left text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-300 dark:hover:bg-gray-700 px-4 py-2 rounded-lg",
