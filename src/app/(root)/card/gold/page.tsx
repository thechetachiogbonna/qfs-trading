  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white transition-all duration-300 pb-20">
      ...
      <div className="flex items-center justify-between p-4">
        ...
        <h1 className="text-xl font-semibold text-center flex-1">Gold Card</h1>
      ...
      <div className="px-4 space-y-6">
        <Card className="w-full bg-white dark:bg-gray-800 overflow-hidden border border-gray-200 dark:border-gray-700">
          <div className="p-6 space-y-4">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white">QFS Trading GOLD CARD</h2>
            ...
            <div className="space-y-3 pt-2 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span className="text-gray-700 dark:text-gray-300">Premium rewards program</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-yellow-500 font-bold">✓</span>
